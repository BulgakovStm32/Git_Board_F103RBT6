...
//*******************************************************************************************
//*******************************************************************************************
void DMAx_Init(DMA_Channel_TypeDef* dma, void* perifAddr){
...
//**********************************************************
//Старт обмена в канале "память-DMA-периферия"
void DMAx_Start(DMA_Channel_TypeDef* dma, uint8_t *txBuf, uint32_t size){

	dma->CCR  &= ~DMA_CCR_EN;    //запретить работу канала
	dma->CMAR  = (uint32_t)txBuf;//адрес буфера в памяти
