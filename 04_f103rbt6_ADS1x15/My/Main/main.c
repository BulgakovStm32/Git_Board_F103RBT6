 ...
 * 	main.c
 *
 *  Created on		: 20 декабря 2023 года.
 *  Autho     		: Беляев А.А.
 *
 *	Описание        : работа с внешним АЦП ADS1015 / 1115 по шине I2C
 *  Датчики         :
 *  Вывод информации:
 *
 */
...
//*******************************************************************************************
//*******************************************************************************************
/* Модуль работы с внешним АЦП ADS1015 / 1115 по шине I2C.
 * Адрес на шине I2C:
 * Скорость обмена по шине I2C:
 */
#define ADS1x15_I2C_ADDR    0x00
#define ADS1x15_I2C_SPEED	100000

//*******************************************************************************************
//*******************************************************************************************
void ADS1x15_Init(uint8_t i2c, uint32_t i2c_speed){
